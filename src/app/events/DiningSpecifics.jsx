...
const DiningSpecifics = ({ title="Our Venues",description="",venueData }) => {
      ...
      <div className="container">
        <div className="row justify-content-center mb-60">
          <div className="col-lg-8 text-center">
           ...
           {description && <p className="section__subtitle mb-4">{description}</p>}
          </div>
        </div>
        <div className="row g-4 justify-content-center">
          {dataToRender.map((item, index) => (
            <div key={index} className="col-lg-6 col-md-10">
              <div
                className="dining-specific-card position-relative overflow-hidden rounded-3"
                style={{ height: "500px" }}
              >
                {/* Background Image */}
                <div
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(to bottom, rgba(0,0,0,0) 0%, rgba(0,0,0,0.2) 50%, rgba(30,32,38,0.95) 100%)",
                  }}
                ></div>
