...
function page() {
  return (
    <>
      ...
      <HeroFive 
        ...
        description="The Presidential Room at Hotel Eden is the pinnacle of luxury and space, designed for guests who seek the finest in comfort and exclusivity. With elegantly appointed interiors, expansive layouts and premium furnishings, this room offers an indulgent stay experience."
      />
  ...
  amenities={[
    ...
    { id: 2, title: "Mineral Water" },
    { id: 3, title: "Complimentary Breakfast" },
    { id: 4, title: "Complimentary Toiletries" },
    { id: 5, title: "Satellite Channels" },
    { id: 6, title: "Flat-screen TV" },
  ]}
/>
