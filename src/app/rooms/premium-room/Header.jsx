  ...
  return (
    <>
      ...
      <div className="header__absolute">
        ...
        <header className={`main__header header__function is__home__two ${hydrated && isSticky ? "is__sticky" : ""}`}>
          <div className="container">
            <div className="row">
              <div className="main__header__wrapper">
                <div className="main__nav">
                  <button className="main__nav__toogler" onClick={() => setIsOffcanvasOpen(true)}>
                ...
                <div className="main__logo">
                  <Link href="/">
                    <img className="logo__class" src="/assets/images/logo/logo__two.svg" alt="moonlit" />
                  </Link>
                </div>
