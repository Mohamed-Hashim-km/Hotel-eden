...
import ServiceOne from "../gokarna/Service";
...
function page() {
  return (
    <>
      ...
      <TopBar />
      <HeaderOne />
      <BreadcrumbOne title="Our Service" description="At Moonlit we pride ourselves on delivering an exceptional experience." />
      <ServiceFive />
      <ServiceOne />
      <TestimonialOne />
      <FooterOne />
